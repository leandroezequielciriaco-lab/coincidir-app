      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.iconCircle}>
            <CircleHelp color="#17803C" size={32} strokeWidth={2.1} />
          </View>
          <Text style={styles.cardTitle}>Centro de ayuda</Text>
          <Text style={styles.cardText}>Acá vas a encontrar respuestas y canales de soporte para usar COINCIDIR con tranquilidad.</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  )
